            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql = "SELECT id, name, logo_url, website_url, city FROM groceries";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>
                                                    ...
                                                    <form method='post' action='edit_groceries.php'>
                                                        <input type='hidden' name='id' value='".$row["id"]."'>
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addCollegeModal">Add groceries</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="add_groceries.php">
