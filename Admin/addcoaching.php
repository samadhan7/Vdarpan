    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Coachings</h5>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if (isset($_POST["delete"])) {
                                        $id = $_POST["id"];
                                        $sql = "DELETE FROM coaching WHERE id='$id'";
                                    ...
                                    $sql = "SELECT id, name, logo_url, website_url, city FROM coaching";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        echo "<tr><td colspan='6'>No Coachings found.</td></tr>";
                                    }
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addCollegeModal">Add Coachings</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="add_coaching.php">
