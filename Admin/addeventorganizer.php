            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if (isset($_POST["delete"])) {
                                        $id = $_POST["id"];
                                        $sql = "DELETE FROM eventorganizer WHERE id='$id'";
                                    ...
                                    $sql = "SELECT id, name, logo_url, website_url, city FROM eventorganizer";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        echo "<tr><td colspan='6'>No event organizers found.</td></tr>";
                                    }
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addCollegeModal">Add Event Organizers</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="add_eventorganizer.php">
