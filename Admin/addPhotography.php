            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql = "SELECT id, name, logo_url, website_url, city FROM photography";
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addCollegeModal">Add photographers</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="add_photography.php">
