            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if (isset($_POST["delete"])) {
                                        $id = $_POST["id"];
                                        $sql = "DELETE FROM laptopservices WHERE id='$id'";
                                    ...
                                    $sql = "SELECT id, name, logo_url, website_url, city FROM laptopservices";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        echo "<tr><td colspan='6'>No laptopservices found.</td></tr>";
                                    }
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addCollegeModal">Add laptop services</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addCollegeModalLabel">Add laptop services</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="add_laptopservices.php">
