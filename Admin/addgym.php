            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql = "SELECT id, name, logo_url, website_url, city FROM gym";
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addCollegeModal">Add Gym</button>
                    </div>
                </div>
            </div>
        </div>
