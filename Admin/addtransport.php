            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql = "SELECT id, name, logo_url, website_url, city FROM transport";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        echo "<tr><td colspan='6'>No transport found.</td></tr>";
                                    }
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addCollegeModal">Add transports</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="add_transport.php">
